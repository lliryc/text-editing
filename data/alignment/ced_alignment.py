...
def align_chars(s1, s2):
    ...
    norm_s1_chars = re.findall(r'PNX.|.', norm_s1)
    norm_s2_chars = re.findall(r'PNX.|.', norm_s2)

    alignments = _gen_alignments(norm_s1_chars, norm_s2_chars, s1_chars,
                                 s2_chars)
