...
DATA_DIR=/scratch/ba63/arabic-text-editing/tagger_data/multi-task/qalb14
OUTPUT_DIR=/scratch/ba63/arabic-text-editing/full_taggers_multi_task/qalb14_check
LABELS=/scratch/ba63/arabic-text-editing/tagger_data/multi-task/qalb14/labels.txt
...
do
    ...
    python tag.py \
        --data_dir $DATA_DIR \
        --labels $LABELS \
        --binary_labels $DATA_DIR/binary_labels.txt \
